...
export class SearchBoxComponent implements OnInit {
  ...
  openSearchResult(URL: string) {
    ...
    document.getElementById('search-box').style.maxWidth = '260px';
    document.getElementById('search-box').style.minWidth = '164px';
    document.getElementById('search-box').style.zIndex = '1';
  ...
  closeSearch() {
    ...
    document.getElementById('search-box').style.maxWidth = '265px';
  ...
  showResult() {
    ...
    if (streetTabRadio.checked) {
      ...
      this.resultTotal = this.searchResults.filter(arr => arr['type'] === 'POI');
    }
  }
